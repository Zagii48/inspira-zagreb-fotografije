                ...
                <CardContent>
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <select 
                        id="service" 
                        className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-inspira focus:border-transparent"
                      >
              ...
              <Card className="shadow-lg">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-inspira rounded-full flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">091 323 8038</p>
                    </div>
                  </div>
                ...
                <CardContent>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-600">Po dogovoru</span>
                    </div>
                    <div className="flex justify-between">
